...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x24f0
#define USBD_PID                      0x2020
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "DieFarbe"
#define USBD_PRODUCT_FS_STRING        "Hello World"
#define USBD_CONFIGURATION_FS_STRING  USBD_PRODUCT_FS_STRING
#define USBD_INTERFACE_FS_STRING      "HID Device"
...
static void Get_SerialNum(void)
{
  ...
  IntToUnicode(deviceserial1, &USBD_StringSerial[18], 8U);
}
